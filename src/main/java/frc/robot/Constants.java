...
public class Constants {
  ...
  public static class kSwerve {
    ...
    public static final double TRACK_WIDTH = Units.inchesToMeters(23.2); // Width of the drivetrain measured from the middle of the wheels.
    public static final double WHEEL_BASE = Units.inchesToMeters(23.2); // Length of the drivetrain measured from the middle of the wheels.
